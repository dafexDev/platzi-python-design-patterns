...
class StripePaymentProcessor(
    ...
    __stripe_api_key: str
    __stripe_price_id: str

    def process_transaction(
        self, customer_data: CustomerData, payment_data: PaymentData
    ) -> PaymentResponse:
        stripe.api_key = self.__stripe_api_key
        try:
    ...
    def refund_payment(self, transaction_id: str) -> PaymentResponse:
        ...
        try:
            ...
            return PaymentResponse(
                status="failed", amount=0, transaction_id=None, message=str(e)
            )
    ...
    def setup_recurring_payment(
        ...
        stripe.api_key = self.__stripe_api_key
        price_id = self.__stripe_price_id
        try:
    ...
    def _set_default_payment_method(self, customer_id: str, payment_method_id: str):
        """
        ...
        print(f"Default payment method set for a customer {customer_id}")
